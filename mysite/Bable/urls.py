...
urlpatterns = [
	...
	path('grabusername/', views.grabusername, name='grabusername'),
	...
	path('change_password_form/', views.change_password, name='change_password_form'),
	path('change_phone_form/', views.change_phone, name='change_phone_form'),
	path('change_email_form/', views.change_email, name='change_email_form'),
	path('begin_verification/', views.begin_verification, name='begin_verification_form'),
	path('begin_verification_start/', views.begin_verification_start, name='begin_verification_form_start'),
	path('email_verification/', views.email_verification, name='email_verification'),
	path('sms_verification/', views.sms_verification, name='sms_verification'),
	...
	path('pages/<count>/', views.tower_of_bable_count, name='tower_of_bable_count'),
	...
	path('user/<user>/post/<post>/count/<count>/comment_count/<comment_count>/', views.tob_users_post, name='tob_users_post'),
