...
urlpatterns = [
	...
	path('email_verification_form/', views.email_verification, name='email_verification_form'),
	path('sms_verification_form/', views.sms_verification, name='sms_verification_form'),
