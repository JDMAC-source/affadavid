	...
	def place_keywords_into_counters(self, body):
		...
		for word_num in range(0, keywords_split.length):
			...
			self.zipfs_law_difference_day.add(ZipfsApproximateDifferenceDay.objects.create(keywords=keywords_split[word_num], year=timezone.now().date().year, month=timezone.now().date().month, day=timezone.now().date().day, author=None, one_by_one=abs(yesterdays_difference.one_by_one-float(one_by_one.appearances_in_body_text)), one_of_one=abs(yesterdays_difference.one_of_one-float(one_of_one.appearances_in_body_text)), 
				...
				four_of_one_second_first_fourth=abs(yesterwday_difference.four_of_one_second_first_fourth-float(four_of_one_second_first_fourth.appearances_in_body_text)), four_of_one_third_first_fourth=abs(yesterdays_difference.four_of_one_third_first_fourth-float(four_of_one_third_first_fourth.appearances_in_body_text)), four_of_one_third_second_fourth=abs(yesterdays_difference.four_of_one_third_second_fourth-float(four_of_one_third_second_fourth.appearances_in_body_text)), four_of_one_fourth_first_fourth=abs(yesterdays_difference.four_of_one_fourth_first_fourth-float(four_of_one_fourth_first_fourth.appearances_in_body_text)), 
				four_of_one_fourth_second_fourth=abs(yesterwday_difference.four_of_one_fourth_second_fourth-float(four_of_one_fourth_second_fourth.appearances_in_body_text)), four_of_one_fourth_third_fourth=abs(yesterdays_difference.four_of_one_fourth_third_fourth-float(four_of_one_fourth_third_fourth.appearances_in_body_text)), four_of_one_fourth_fourth_fourth=abs(yesterdays_difference.four_of_one_fourth_fourth_fourth-float(four_of_one_fourth_fourth_fourth.appearances_in_body_text)), 
