...
class ZipfsLawStatSignature(models.Model):
	...
	def place_keywords_into_counters(self, body):
		...
		for word_num in range(0, keywords_split.length):
			...
			self.zipfs_law_self_difference_day_significance.add(ZipfsApproximateDifferenceDay.objects.create(keywords=keywords_split[word_num], year=timezone.now().date().year, month=timezone.now().date().month, day=timezone.now().date().day, author=self.author, one_by_one=(yesterdays_difference.one_by_one-float(one_by_one.appearances_in_body_text))/(float(count_doubles)**2), one_of_one=(yesterdays_difference.one_of_one-float(one_of_one.appearances_in_body_text))/(float(count)**2), one_skip_one_by_one=(yesterdays_difference.one_skip_one_by_one-float(one_skip_one_by_one.appearances_in_body_text))/(float(count_doubles)**2), one_skip_two_by_one=abs(yesterdays_difference.one_skip_two_by_one-float(one_skip_two_by_one.appearances_in_body_text))/(float(count_quads)**2), 
				one_skip_three_by_one=abs(yesterdays_difference.one_skip_three_by_one-float(one_skip_three_by_one.appearances_in_body_text))/(float(count_quints)**2), one_skip_four_by_one=abs(yesterdays_difference.one_skip_four_by_one-float(one_skip_four_by_one.appearances_in_body_text))/(float(count_sext)**2), one_skip_five_by_one=abs(yesterdays_difference.one_skip_five_by_one-float(one_skip_five_by_one.appearances_in_body_text))/(float(count_sept)**2), two_skip_one_by_one=abs(yesterdays_difference.two_skip_one_by_one-float(two_skip_one_by_one.appearances_in_body_text))/(float(count_quads)**2), two_skip_two_by_one=abs(yesterdays_difference.two_skip_two_by_one-float(two_skip_two_by_one.appearances_in_body_text))/(float(count_quints)**2), 
				two_skip_three_by_one=abs(yesterdays_difference.two_skip_three_by_one-float(two_skip_three_by_one.appearances_in_body_text))/(float(count_sext)**2), two_skip_four_by_one=abs(yesterdays_difference.two_skip_four_by_one-float(two_skip_four_by_one.appearances_in_body_text))/(float(count_sept)**2), two_skip_five_by_one=abs(yesterdays_difference.two_skip_five_by_one-float(two_skip_five_by_one.appearances_in_body_text))/(float(count_oct)**2), one_skip_one_by_two=abs(yesterdays_difference.one_skip_one_by_two-float(one_skip_one_by_two.appearances_in_body_text))/(float(count_quads)**2), one_skip_two_by_two=abs(yesterdays_difference.one_skip_two_by_two-float(one_skip_two_by_two.appearances_in_body_text))/(float(count_quints)**2), 
				one_skip_three_by_two=abs(yesterdays_difference.one_skip_three_by_two-float(one_skip_three_by_two.appearances_in_body_text))/(float(count_sext)**2), one_skip_four_by_two=abs(yesterdays_difference.one_skip_four_by_two-float(one_skip_four_by_two.appearances_in_body_text))/(float(count_sept)**2), one_skip_five_by_two=abs(yesterdays_difference.one_skip_five_by_two-float(one_skip_five_by_two.appearances_in_body_text))/(float(count_oct)**2), two_skip_one_by_two=abs(yesterdays_difference.two_skip_one_by_two-float(two_skip_one_by_two.appearances_in_body_text))/(float(count_quints)**2), two_skip_two_by_two=abs(yesterdays_difference.two_skip_two_by_two-float(two_skip_two_by_two.appearances_in_body_text))/(float(count_sext)**2), 
				two_skip_three_by_two=abs(yesterdays_difference.two_skip_three_by_two-float(two_skip_three_by_two.appearances_in_body_text))/(float(count_sept)**2), two_skip_four_by_two=abs(yesterdays_difference.two_skip_four_by_two-float(two_skip_four_by_two.appearances_in_body_text))/(float(count_oct)**2), two_skip_five_by_two=abs(yesterdays_difference.two_skip_five_by_two-float(two_skip_five_by_two.appearances_in_body_text))/(float(count_non)**2), two_by_two_first=abs(yesterdays_difference.two_by_two_first-float(two_by_two_first.appearances_in_body_text))/(float(count_doubles)**2), two_by_two_second=abs(yesterdays_difference.two_by_two_second-float(two_by_two_second.appearances_in_body_text))/(float(count_doubles)**2), 
